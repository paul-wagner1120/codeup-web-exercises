// I have to finish the functions exercises still...All code seen below is from David's walk through of the exercises.
...
// //  */
//
// function calcTip(tipPercent, total) {
//     let tipAmount = total * tipPercent;
//     return tipAmount;
// }
//     console.log(calcTip(.2, 20));
...
// //  */
//
//     let userTotal = prompt("How much was your total bill?");
//     let userTip = parseFloat(prompt("What percentage would you like to tip?"))/100;
//
//     alert("You'll add $" + calcTip(userTip, userTotal).toFixed(2) + " to your bill today");
//
// // /**
// //  * TODO:
...
//     let totalDiscount = itemPrice - (itemPrice *itemDiscount);
